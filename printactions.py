...
class PrintActions:
    ...
    def print_actions_find_notes_by_several_params(self):
        print('Введите несколько параметров для поиска информации без запятых.')
